# SMOD Troopers 0.9.9 installation
...
1. Download the mod
   ...
   - <https://www.moddb.com/mods/smod-troopers/downloads/smod-troopers-099>

2. Install the mod to your sourcemods folder i.e.

   ```text
   C:\Program Files (x86)\Steam\steamapps\sourcemods\SmodTroopers
   ```

3. Enable `smodtroopers` in `sourcemods.install.settings.json`
